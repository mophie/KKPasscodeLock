Pod::Spec.new do |s|
  ...
  s.version  = '0.1.5-mophie'
  s.license  = 'Apache 2.0'
  s.summary  = 'KKPasscodeLock is an iOS toolkit for adding a passcode view controller and passcode settings in ios apps'
  s.homepage = 'https://github.com/mophie/KKPasscodeLock.git'
  s.author   = { 'mophie' => 'TODO-mophie-software@mophie.com' }
  s.source   = { :git => 'https://github.com/mophie/KKPasscodeLock.git' }
  s.platform = :ios
